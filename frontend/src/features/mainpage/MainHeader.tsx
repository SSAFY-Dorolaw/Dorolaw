      ...
      <div className="absolute inset-0 mt-10 flex flex-col items-center justify-center pt-20 text-white">
        <section className="mb-10 mt-[-110px]">
          ...
          <p className="mb-8 text-center text-2xl font-bold">
            블랙박스 | CCTV 영상 업로드시 AI가 과실 비율을 분석, 변호사 상담까지
            연결!
          </p>
        </section>
        ...
        <nav className="flex space-x-6">
          ...
          <button
            onClick={goToReport}
            className="mr-5 w-[330px] rounded-[10px] bg-y5 px-8 py-9 text-h3 font-bold text-black transition duration-300 hover:bg-y3"
          >
            AI 과실비율 분석 시작하기
          </button>
