    ...
    <div className="w-full">
      ...
      <header className="flex h-[54px] items-center px-4">
        ...
        <div className="reservation ml-2">
          <button className="rounded-[10px] bg-p5 px-2 text-bodysmall text-p1">
            상담 예약
          </button>
        </div>
      </header>
      <article className="whitespace-pre-wrap p-4">
        ...
        <p>
          ...
          제공 서비스
          <br />
          Step1. 무료 전화 상담을 진행합니다.
          <br />
          Step2. 상담 진행 후 소송 진행 여부 등을 협의합니다.
          <br />
          Step3. 의뢰인 맞춤형으로 소송 등을 진행합니다.
          <br />
          김승소 변호사 대성 국제 법률 사무소
          <br />
          01012345678 유사 사건 경험 변호사 경력 30년으로 풍부한 노하우를
          제공합니다. 그동안 쉴틈없이 매주 법원을 2회 이상 들려 소송 진행 등을
          왔습니다. 형사 민사 가릴 거 없이 거의 다루어보았고, 관련 자문을
