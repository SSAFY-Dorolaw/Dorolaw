...
class Yolo_tsn_recognizer():
    def __init__(self):
        ...
        config = 'model/TSN/best_model_0527/best_model/tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb.py'
        config = Config.fromfile(config)
        
        # 로드할 체크포인트 파일을 설정합니다.
        checkpoint = 'model/TSN/best_model_0527/best_model/best_model_0527.pth'
    ...
    def predict(self, video_path):
        ...
        # 딕셔너리를 JSON 파일로 저장
        with open('recognizer/output/yolo_tsn_result.json', 'w', encoding='utf-8') as file:
...
if __name__=="__main__":
    ...
    print(ysr.predict("recognizer/demo_video/cc_5.mp4"))
