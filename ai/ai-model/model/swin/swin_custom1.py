...
_base_ = [
    '/home/ubuntu/Dorolaw/ai-model/external/mmaction2/configs/_base_/models/swin_tiny.py', 
...
# ann_file_test  = 'datasets/accident_aihub/processed/test/annotation_index_test_mp4.txt'  # 테스트용 없으면 val 재사용
...
# work_dir = './work_dirs/swin_custom1'       # 추가
# work_dir = 'work_dirs/train/swin_custom1'
work_dir = '/home/j-j12a501/Dorolaw/ai-model/work_dirs/train/swin_custom1'